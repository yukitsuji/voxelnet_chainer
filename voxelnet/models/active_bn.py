...
# from chainer import func_active_bn
from voxelnet.models import func_active_bn
...
class BatchNormalization(link.Link):
    ...
    """Batch normalization layer on outputs of linear or convolution func_active_bn.

    This link wraps the :func:`~chainer.func_active_bn.batch_normalization` and
    :func:`~chainer.func_active_bn.fixed_batch_normalization` func_active_bn.
    ...
    .. seealso::
       :func:`~chainer.func_active_bn.batch_normalization`,
       :func:`~chainer.func_active_bn.fixed_batch_normalization`
